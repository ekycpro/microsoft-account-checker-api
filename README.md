# Microsoft Checker API — official examples | eKYC Pro

This repository documents the eKYC Pro Microsoft Checker API integration contract using facts from the expansion manifest.

- Product page: https://ekycpro.com/tools/microsoft
...
```bash
curl -X POST "https://api.ekycpro.com/v1/check" -H "X-API-Key: ${EKYCPRO_API_KEY}" -H "Content-Type: application/json" -d '{"service_type":"microsoft","identifier":"+14155550100"}'
```
...
| --- | --- | --- | --- | --- | --- |
| `microsoft` | Microsoft Checker | phone | 1–1 identifier | `id, identifier, registered, billed, cost, cost_usd` | [docs](https://docs.ekycpro.com/microsoft-checker) |
...
- `microsoft`: https://docs.ekycpro.com/microsoft-checker
